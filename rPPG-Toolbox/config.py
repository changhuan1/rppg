...
_C.TRAIN.DATA.SPLIT_METHOD = 'subject_order'
...
_C.VALID.DATA.SPLIT_METHOD = 'subject_order'
...
_C.TEST.DATA.SPLIT_METHOD = 'subject_order'
...
_C.UNSUPERVISED.DATA.SPLIT_METHOD = 'subject_order'
